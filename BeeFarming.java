...
public class BeeFarming extends JFrame{
	...
	public BeeFarming(){
		...
		for(int n=0;n<2;n++){
			...
			if(n=0){
				bees[1]=(HoneyBee)Class.forname("group._2.HoneyBee").newInstance(0,435,210,176,true,imgBee);
				bees[2]=(HoneyBee)Class.forname("group._2.HoneyBee").newInstance(1,130,230,145,true,imgBee);
				bees[3]=(HoneyBee)Class.forname("group._2.HoneyBee").newInstance(2,730,370,40,true,imgBee);
				bees[9]=(Hornet)Class.forname("group._3.Hornet").newInstance(9,490,500,240,true,imgBee2);
			}
			else {
				while(begin){}
				bees[1]=(HoneyBee)Class.forname("group._3.HoneyBee").newInstance(0,435,210,176,true,imgBee);
				bees[2]=(HoneyBee)Class.forname("group._3.HoneyBee").newInstance(1,130,230,145,true,imgBee);
				bees[3]=(HoneyBee)Class.forname("group._3.HoneyBee").newInstance(2,730,370,40,true,imgBee);
				bees[9]=(Hornet)Class.forname("group._2.Hornet").newInstance(9,490,500,240,true,imgBee2);
                ...
                time = 0;
                count = 3;	//蜜蜂数量
                countflower = 20;//花的数量，包括未开发的
                Beegoal = 0;//存活蜜蜂可以兑换的积分总数 
                String game = "";
                totalHoney = 0;
			}
